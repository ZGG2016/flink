...
public class HotPages {
    public static void main(String[] args) throws Exception {
        ...
        // 读取文件，转换成POJO
//        DataStream<String> inputStream = env.readTextFile("E:\\file\\正在进行中\\UserBehaviorAnalysis\\NetworkFlowAnalysis\\src\\main\\resources\\apache.log");
        DataStream<String> inputStream = env.socketTextStream("bigdata101", 7777);
...
//        ListState<PageViewCount> pageViewCountListState;
        // 保存进来的状态会替换 key相同的前面的状态
        // 就不会出现 输出同一url的前一次浏览量和当前浏览量
