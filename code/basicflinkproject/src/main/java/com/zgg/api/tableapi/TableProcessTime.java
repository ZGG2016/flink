...
//        });
        ...
        // 定义处理时间
        // 1.方式一
//        Table sensor = tableEnv.fromDataStream(dataStream, "id, timestamp as ts, temperature, pt.proctime");
        // pt: TIMESTAMP(3) *PROCTIME*   精确到3位毫秒
//        sensor.printSchema();
...
//        String sql = "select id, ts, temperature, pt from sensor where id = 'sensor_6'";
