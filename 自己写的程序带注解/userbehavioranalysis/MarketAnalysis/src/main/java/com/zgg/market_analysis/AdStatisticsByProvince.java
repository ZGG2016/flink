package com.zgg.market_analysis;

import com.zgg.market_analysis.beans.AdClickEvent;
import com.zgg.market_analysis.beans.AdCountViewByProvince;
import com.zgg.market_analysis.beans.BlackListUserWarning;
...
public class AdStatisticsByProvince {
    ...
    public static class FilterBlackListUser extends KeyedProcessFunction<Tuple, AdClickEvent, AdClickEvent>{
        ...
        public void processElement(AdClickEvent value, Context ctx, Collector<AdClickEvent> out) throws Exception {
            ...
            // 1. 判断是否是第一个数据，如果是的话，注册一个第二天0点的定时器【用于清理状态】
            if( curCount == 0 ){
